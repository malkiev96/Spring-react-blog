...
class UserDetail extends Component {
  ...
  constructor(props) {
    ...
    const profile = props.currentUser.authenticated
        && props.currentUser.currentUser.id === id
    this.state = {
      id: id,
      profile: profile,
      user: {
  ...
  render() {
    ...
    return (
        <div>
          <Segment>
            <Header as='h2'>
              <Image avatar src={getDocumentSrc(user.user?.preview?.fileId)}/>
              {user.user.name}
              {
                  profile &&
          ...
          </Segment>
          {
              ...
              <Tabs>
                ...
                <TabPanel>
                  <UserPosts id={user.user.id}
                             status={'PUBLISHED'}/>
                </TabPanel>
                <TabPanel>
                  <UserPosts liked id={user.user.id}
                             status={'PUBLISHED'}/>
                </TabPanel>
              </Tabs>
          }
