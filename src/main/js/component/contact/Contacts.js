...
import {getAdmins, sendContactMessage} from "../../api/UserService";
        ...
        <div>
          <Segment>
              ...
              <Table.Body>
                {
                  admins.map(admin =>
                      <Table.Row key={admin.id}>
                        <Table.Cell>
                          <Header as='h4' image>
                            <Image src={getDocumentSrc(admin?.preview?.fileId)}
                                   rounded size='mini'/>
                            <Header.Content>
            ...
            <Form onSubmit={this.handleSubmit}>
              ...
              <Button style={{backgroundColor: '#175e6b'}} content='Отправить'
                      primary/>
            </Form>
          </Segment>
        </div>
